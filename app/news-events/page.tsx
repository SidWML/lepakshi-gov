                  ...
                  >
                    ...
                    <div className="p-5 flex flex-col flex-1">
                      ...
                      <div className="pt-3 border-t border-[#c9a227]/20 mt-auto">
                        <button className="inline-flex items-center gap-1 text-sm font-semibold text-[#3d3428] group-hover:text-[#c9a227] transition-colors font-[family-name:var(--font-montserrat)]">
                          Read More
